      ...
      <div className="container py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="#demo" className="text-sm hover:text-primary">Request Demo</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/api" className="text-sm hover:text-primary">API Reference</Link></li>
